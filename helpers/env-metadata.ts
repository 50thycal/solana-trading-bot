...
export const ENV_CATEGORIES: EnvCategory[] = [
  ...
  {
    id: 'research_score_gate',
    label: 'Research Score Gate',
    description: 'ML model scoring from the research bot (Pipeline Stage 5)',
    vars: [
      {
        name: 'RESEARCH_SCORE_GATE_ENABLED',
        label: 'Research Score Gate Enabled',
        type: 'boolean',
        defaultValue: 'true',
        description: 'Enable research score gate for ML model scoring',
      },
      {
        name: 'RESEARCH_MIN_OPPORTUNITY_SCORE',
        label: 'Min Opportunity',
        type: 'number',
        defaultValue: '60',
        description: 'Minimum opportunity score to pass (0-100)',
        hint: '0-100',
      },
      {
        name: 'RESEARCH_MAX_RISK_SCORE',
        label: 'Max Risk',
        type: 'number',
        defaultValue: '45',
        description: 'Max dump/rug risk score (0-100). Tokens above this are rejected.',
        hint: '0-100',
      },
      {
        name: 'RESEARCH_CHECKPOINT_SECONDS',
        label: 'Checkpoint (s)',
        type: 'number',
        defaultValue: '30',
        description: 'Checkpoint age for /api/analysis/score request',
      },
      {
        name: 'RESEARCH_REQUEST_TIMEOUT_MS',
        label: 'Request Timeout (ms)',
        type: 'number',
        defaultValue: '1500',
        description: 'Score request timeout per attempt',
      },
      {
        name: 'RESEARCH_RETRIES',
        label: 'Retries',
        type: 'number',
        defaultValue: '2',
        description: 'Retry count for score API request (exponential backoff)',
      },
      {
        name: 'RESEARCH_FAIL_MODE',
        label: 'Fail Mode',
        type: 'string',
        defaultValue: 'closed',
        description: 'closed=reject on API error, open=pass on API error',
      },
      {
        name: 'RESEARCH_SCORE_LOG_ONLY',
        label: 'Log Only Mode',
        type: 'boolean',
        defaultValue: 'true',
        description: 'Compute score but always pass gate (for data collection)',
      },
      {
        name: 'RESEARCH_SCORE_MODEL_REFRESH_INTERVAL',
        label: 'Model Refresh Interval (ms)',
        type: 'number',
        defaultValue: '300000',
        description: 'How often to refresh scoring model from research bot (milliseconds)',
      },
      {
        name: 'RESEARCH_SCORE_POLL_INTERVAL_SECONDS',
        label: 'Poll Interval (s)',
        type: 'number',
        defaultValue: '3',
        description: 'Seconds between transaction polling during checkpoint wait',
      },
      {
        name: 'RESEARCH_SCORE_SIGNATURE_LIMIT',
        label: 'Signature Limit',
        type: 'number',
        defaultValue: '40',
        description: 'Max transaction signatures to fetch per poll (1-100)',
      },
      {
        name: 'RESEARCH_SCORE_SNIPER_SLOT_THRESHOLD',
  ...
  },
  {
    id: 'stable_gate',
    label: 'Stable Gate',
    description: 'Final buy-readiness check: price stabilization, curve re-validation, sell ratio (Pipeline Stage 6)',
    vars: [
      {
        name: 'STABLE_GATE_ENABLED',
        label: 'Stable Gate Enabled',
        type: 'boolean',
        defaultValue: 'true',
        description: 'Enable stable gate for final buy-readiness check',
      },
      {
        name: 'STABLE_GATE_LOG_ONLY',
        label: 'Log Only Mode',
        type: 'boolean',
        defaultValue: 'false',
        description: 'Run all checks but always pass gate (for data collection)',
      },
      {
        name: 'STABLE_GATE_MAX_RETRIES',
        label: 'Max Retries',
        type: 'number',
        defaultValue: '5',
        description: 'Max retry attempts before rejecting',
        hint: '>= 0',
      },
      {
        name: 'STABLE_GATE_RETRY_DELAY_SECONDS',
        label: 'Retry Delay (s)',
        type: 'number',
        defaultValue: '5',
      ...
      {
        name: 'STABLE_GATE_PRICE_SNAPSHOTS',
        label: 'Price Snapshots',
        type: 'number',
        defaultValue: '3',
        description: 'Number of bonding curve snapshots for price trend',
        hint: '>= 2',
      },
      {
        name: 'STABLE_GATE_SNAPSHOT_INTERVAL_MS',
        label: 'Snapshot Interval (ms)',
        type: 'number',
        defaultValue: '500',
        description: 'Milliseconds between price snapshots',
      },
      {
        name: 'STABLE_GATE_MAX_PRICE_DROP_PERCENT',
        label: 'Max Price Drop %',
        type: 'number',
        defaultValue: '5',
        description: 'Max allowed price decline across snapshots (%)',
      },
      {
        name: 'STABLE_GATE_MIN_SOL_IN_CURVE',
        label: 'Min SOL in Curve',
        type: 'number',
        defaultValue: '0',
        description: 'Min SOL in curve post-dump (0 = use PUMPFUN_MIN_SOL_IN_CURVE)',
        hint: '0 = auto',
      },
      {
        name: 'STABLE_GATE_MAX_SELL_RATIO',
        label: 'Max Sell Ratio',
        type: 'number',
        defaultValue: '0.4',
        description: 'Max sell ratio (sells/total txs). Reject if exceeded.',
        hint: '0-1',
      },
    ],
  },
